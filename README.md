...
Place the downloaded files in `data/processed/zenodo/`. File contents,
dimensions, and checksums are listed in
...
Rendered notebook HTML files are kept beside their `.Rmd` sources and include
the figures generated by each analysis. The final publication-quality figure
files are provided with the manuscript rather than duplicated in this
repository.
